...
def analyze_review_sentiments(text):
    ...
    response = natural_language_understanding.analyze( text=text+"Testing Testing",features=Features(sentiment=SentimentOptions(targets=[text+"Checking 1"]))).get_result()
